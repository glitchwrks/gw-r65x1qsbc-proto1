...
LIBS:gw-r65x1qsbc-proto1-cache
EELAYER 26 0
EELAYER END
...
Wire Wire Line
	6750 5550 6850 5550
$Comp
L gw_computer_busses:GLITCHBUS_1.0 J5
U 1 1 5E51F92E
P 7300 1750
F 0 "J5" H 7300 1750 50  0000 C CNN
F 1 "GLITCHBUS" H 7300 1650 50  0000 C CNN
F 2 "gw_headers:STRAIGHT_2x20_NOSILK" H 7300 1750 50  0001 C CNN
...
F 2 "gw_headers:STRAIGHT_2x5_NOSILK" H 4750 1300 50  0001 C CNN
...
PD0
Text GLabel 3700 2700 2    50   BiDi ~ 0
PD2
...
F 1 "GND" H 3055 2974 50  0000 C CNN
...
F 1 "GND" H 4955 2974 50  0000 C CNN
...
Text Notes 4450 3350 2    60   ~ 0
I/O Port Breakouts
$Comp
L gw_computer_busses:R65X1QSBC_PORTB J4
U 1 1 65805720
P 4950 2700
F 0 "J4" H 4950 3165 50  0000 C CNN
F 1 "PORT B" H 4950 3074 50  0000 C CNN
F 2 "gw_headers:STRAIGHT_2x5" H 4750 2550 50  0001 C CNN
...
Wire Wire Line
	4950 3100 5500 3100
$Comp
L gw_computer_busses:R65X1QSBC_PORTD J1
U 1 1 6580572C
P 3050 2700
F 0 "J1" H 3050 3165 50  0000 C CNN
F 1 "PORT D" H 3050 3074 50  0000 C CNN
F 2 "gw_headers:STRAIGHT_2x5_NOSILK" H 2850 2550 50  0001 C CNN
...
BD1
Text GLabel 9450 3950 2    50   BiDi ~ 0
BD2
Text GLabel 9450 3850 2    50   BiDi ~ 0
BD3
Text GLabel 9450 3750 2    50   BiDi ~ 0
BD4
Text GLabel 9450 3650 2    50   BiDi ~ 0
BD5
...
BA14
Text GLabel 7650 3650 0    50   Output ~ 0
BA13
Text GLabel 7650 3750 0    50   Output ~ 0
BA12
...
BA8
Text GLabel 9450 4950 2    50   UnSpc ~ 0
*BRESET
Text GLabel 9450 4650 2    50   Input ~ 0
*BMASK
Text GLabel 9450 4550 2    50   Output ~ 0
*BSTART
Text GLabel 9450 5050 2    50   Output ~ 0
BCLOCK
...
Wire Wire Line
	9250 4850 9450 4850
$Comp
L gw_computer_busses:GLITCHBUS_1.0 J6
U 1 1 6580A235
P 8550 4150
F 0 "J6" H 8550 4150 50  0000 C CNN
F 1 "GLITCHBUS" H 8550 4050 50  0000 C CNN
F 2 "gw_headers:STRAIGHT_2x20" H 8550 4150 50  0001 C CNN
